...
<html>
  <body>
    ...
    <button
      type="button"
      onclick="document.getElementById('myImage').src='/tutorial/img/svg/static_assets.svg'"
    >
      Change Image
    </button>
  </body>
...
<BrowserWindow minHeight="200px" url="http://127.0.0.1:5500/index.html">
<h1>My First JavaScript</h1>
    <img
      id="myImage"
      src='/tutorial/img/svg/static_website.svg'
      ...
      height="auto"
    />
    <button onClick={()=> document.getElementById('myImage').src='/tutorial/img/svg/static_assets.svg'}>Change Image</button>
</BrowserWindow>
